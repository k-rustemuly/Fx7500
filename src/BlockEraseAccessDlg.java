 ...
 * @author CFRN78
 */
public class BlockEraseAccessDlg extends javax.swing.JDialog
                           implements DocumentListener {


    String tagID;
    /** Creates new form ReadAccessDlg */
    public BlockEraseAccessDlg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(jButtonErase, javax.swing.GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jButtonEraseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEraseActionPerformed
        try {
            ...
            blkEraseAccessParams.setByteCount(Integer.parseInt(jTextFieldLength.getText()));
            blkEraseAccessParams.setByteOffset(Integer.parseInt(jTextFieldOffset.getText()));
            blkEraseAccessParams.setAccessPassword(Long.parseLong(jTextFieldPwd.getText(), 16));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BlockEraseAccessDlg dialog = new BlockEraseAccessDlg(new javax.swing.JFrame(), true);
